 ...
 * executable.
 *
 * You can either draw the state at each step --- graphvizShowSteps(true) --- or
 * you can draw states selectively by calling TraceGraph.draw() from the program
 * you are tracing. See the example in TraceTest.java
 *
 * !!!!!!!!!!!!!!!!!!!!!!!! COMPILATION !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 *
...
public class Trace {
     ...
     * and Trace.graphvizShowSteps() is false.
     */
    ...
    /**
     * Sets the graphviz output filename prefix and resets the image counter.
     * Generated filenames have the form:
     * 
     * <pre>
     * (user home directory)/(filenamePrefix)(counter)-(method and line number information)
     * </pre>
     */
    public static void setGraphizOutputFilenamePrefixRelativeToUserHome (String filenamePrefix) {
        setGraphizOutputFilenamePrefix (System.getProperty ("user.home") + File.separator + filenamePrefix);
    }
    /**
     * Sets the graphviz output filename prefix and resets the image counter.
     ...
     * 
     * <pre>
     * (filenamePrefix)(counter)-(method and line number information)
     * </pre>
     */
    public static void setGraphizOutputFilenamePrefix (String filenamePrefix) {
        Graphviz.setOutputFilenamePrefix (filenamePrefix);
    }
    ...
    // Basic options -- 
    /**
     * Create a new graphviz drawing for every step (default==false).
     */
    public static void graphvizShowSteps (boolean value) {
        GRAPHVIZ_SHOW_STEPS = value;
    }
    protected static boolean GRAPHVIZ_SHOW_STEPS = false;
    /**
     * Show thread events on the console (default==true).
     */
    public static void consoleShowThreads (boolean value) {
        CONSOLE_SHOW_THREADS = value;
    }
    protected static boolean CONSOLE_SHOW_THREADS = true;
    /**
     * Show class loading information on the console (default==true).
     */
    public static void consoleShowClasses (boolean value) {
        CONSOLE_SHOW_CLASSES = value;
    }
    protected static boolean CONSOLE_SHOW_CLASSES = true;
    /**
     * Show method calls and returns on the console (default==true).
     */
    public static void consoleShowCalls (boolean value) {
        CONSOLE_SHOW_CALLS = value;
    }
    protected static boolean CONSOLE_SHOW_CALLS = true;
    /**
     * Show linenumbers on the console as they are executed (default==true). If
     * set to false, then consoleShowStepsVerbose and consoleShowVariables are
     * also set to false.
     */
    public static void consoleShowSteps (boolean value) {
        CONSOLE_SHOW_STEPS = value;
        if (!value) {
            CONSOLE_SHOW_STEPS_VERBOSE = false;
            CONSOLE_SHOW_VARIABLES = false;
        }
    }
    protected static boolean CONSOLE_SHOW_STEPS = true;
    /**
     * Show linenumbers and code on the console as they are executed
     * (default==false). If set to true, then consoleShowSteps is also set to
     * true.
     */
    public static void consoleShowStepsVerbose (boolean value) {
        CONSOLE_SHOW_STEPS_VERBOSE = value;
        if (value) CONSOLE_SHOW_STEPS = true;
    }
    protected static boolean CONSOLE_SHOW_STEPS_VERBOSE = false;
    /**
     * Show the variables changed at each step on the console (default==true).
     * If set to true, then consoleShowSteps is also set to true.
     */
    public static void consoleShowVariables (boolean value) {
        CONSOLE_SHOW_VARIABLES = value;
        if (value) CONSOLE_SHOW_STEPS = true;
    }
    protected static boolean CONSOLE_SHOW_VARIABLES = true;
    /**
     * Show String values as primitives (default==true).
     */
    public static void showStringsAsPrimitive (boolean value) {
        SHOW_STRINGS_AS_PRIMITIVE = value;
    }
    protected static boolean SHOW_STRINGS_AS_PRIMITIVE = true;
    /**
     * Show Integer as int, Double as double, etc (default==true).
     */
    public static void showBoxedPrimitivesAsPrimitive (boolean value) {
        SHOW_BOXED_PRIMITIVES_AS_PRIMITIVE = value;
    }
    protected static boolean SHOW_BOXED_PRIMITIVES_AS_PRIMITIVE = true;
    /**
     * Show consoleShowThreads, consoleShowClasses, consoleShowSteps and
     * consoleShowCalls to false.
     */
    public static void consoleHideAll () {
        Trace.CONSOLE_SHOW_THREADS = false;
        Trace.CONSOLE_SHOW_CLASSES = false;
        Trace.CONSOLE_SHOW_CALLS = false;
        Trace.CONSOLE_SHOW_STEPS = false;
    }
    ...
    public static void run (String[] args) {
        ...
        Trace.internalRun (mainClassName, args, true);
    }
    /**
    ...
    public static void run (String mainClassName) {
        Trace.internalRun (mainClassName, new String[] {}, false);
    }
    /**
     * Run the debugger on the given class. The current program will continue to
     * execute after this call to run has completed.
    ...
    public static void run (String mainClassName, String[] args) {
        internalRun (mainClassName, args, false);
    }
    /**
     * Run the debugger on the given class. The current program will continue to
     * execute after this call to run has completed.
    ...
    public static void run (Class<?> mainClass, String[] args) {
        Trace.internalRun (mainClass.getCanonicalName (), args, false);
    }
    /**
     * Run the debugger on the given class. The current program will continue to
     * execute after this call to run has completed.
    ...
    public static void runWithArgs (String mainClassName, String... args) {
        Trace.internalRun (mainClassName, args, false);
    }
    /**
    ...
    private static void internalRun (String mainClassName, String[] args, boolean terminateAfter) {
        int length = PREFIX_ARGS_FOR_VM.size ();
        ...
        internalRun (allArgs, terminateAfter);
    }
    /**
    ...
    private static void internalRun (String[] allArgs, boolean terminateAfter) {
     ...
     * exclude pattern are ignored by the debugger. The default exclude patterns
     * are:
     * 
     * <pre>
     *  "java.*"  "sun.*"  "javax.*"  "com.*"  "stdlib.*"  "Jama.*"  "qs.*"
     * </pre>
     * 
     * Exclude patterns must include "java.*" and "sun.*"
     */
    ...
    protected static HashSet<String> EXCLUDE_PATTERNS;
    static {
        EXCLUDE_PATTERNS = new HashSet<> ();
        EXCLUDE_PATTERNS.add ("java.*");
        EXCLUDE_PATTERNS.add ("sun.*");
        EXCLUDE_PATTERNS.add ("stdlib.*");
        EXCLUDE_PATTERNS.add ("javax.*");
        EXCLUDE_PATTERNS.add ("com.*");
        EXCLUDE_PATTERNS.add ("Jama.*");
        EXCLUDE_PATTERNS.add ("qs.*");
    }
    /**
    ...
    public static void removeDrawingIncludePattern (String value) {
        INCLUDE_PATTERNS.remove (value);
    }
    protected static HashSet<String> INCLUDE_PATTERNS;
    static {
        INCLUDE_PATTERNS = new HashSet<> ();
        INCLUDE_PATTERNS.add ("java.util.*");
    }
    /**
     * When the debugged program ends, create a graphviz file showing the call tree (default==false).
     */
    public static void showCallTree (boolean value) { SHOW_CALL_TREE = value; }
    ...
    /**
     * Show methods introduced by the compiler (default==false);
     */
    public static void showSyntheticMethods (boolean value) {
        SHOW_SYNTHETIC_METHODS = value;
    }
    protected static boolean SHOW_SYNTHETIC_METHODS = false;
    /**
     * Show file names on the console (default==false).
     */
    public static void graphvizShowFilenamesOnConsole (boolean value) {
     ...
     */
    public static void graphvizShowFieldNamesInLabels (boolean value) {
     ...
     */
    public static void graphvizShowObjectIds (boolean value) {
        GRAPHVIZ_SHOW_OBJECT_IDS = value;
    }
    protected static boolean GRAPHVIZ_SHOW_OBJECT_IDS = false;
    /**
     * In graphviz, show null fields (default==false).
     */
    public static void graphvizShowNullFields (boolean value) {
        GRAPHVIZ_SHOW_NULL_FIELDS = value;
    }
    protected static boolean GRAPHVIZ_SHOW_NULL_FIELDS = false;
    /**
     * Show String and Integer, Double, etc as simple boxes if they are not
     * shown as primitive (default==true).
     */
    public static void graphvizShowBoxedPrimitivesSimply (boolean value) {
        GRAPHVIZ_SHOW_BOXED_PRIMITIVES_SIMPLY = value;
    }
...
/* private static */class JDIEventMonitor extends Thread {
    ...
    private void setEventRequests () {
        ...
        }
        {
            ...
            for (String s : Trace.EXCLUDE_PATTERNS)
...
/* private static */class Printer implements IndentPrinter, JDIEventHandler {
    ...
    public void methodEntryEvent (MethodEntryEvent event) {
        ...
        if (!Trace.CALLBACK_CLASS_NAME.equals (calledMethodClassname)) {
            ...
            } else if (Trace.CALLBACK_DRAW_ALL_FRAMES.equals (name) 
                    || Trace.CALLBACK_DRAW_THIS_FRAME.equals (name) 
                    || Trace.CALLBACK_DRAW_OBJECT.equals (name) 
                    || Trace.CALLBACK_DRAW_OBJECTS.equals (name) 
                    || Trace.CALLBACK_DRAW_OBJECT_NAMED.equals (name)
                    || Trace.CALLBACK_DRAW_OBJECTS_NAMED.equals (name) 
            ) {
    ...
    public void exceptionEvent (ExceptionEvent event) {
        ...
        if (catchLocation == null) {
            ...
            if (Trace.GRAPHVIZ_SHOW_STEPS) Graphviz.drawFrames (0, null, null, event.exception (), null, staticClasses);
        } else {
    ...
    public void stepEvent (StepEvent event) {
        ...
        if (Trace.GRAPHVIZ_SHOW_STEPS) {
            try {
                Graphviz.drawFrames (0, Format.methodToString (loc.method (), true, false, "_") + "_" + Integer.toString (loc.lineNumber ()), returnValues.get (thr),
    ...
    public void println (ThreadReference thr, String string) {
        ...
        if (values.numThreads () > 1) Printer.out.printf ("%-9s: ", thr.name ());
...
/* private static */class Format {
    ...
    private static final ArrayList<String> EXCLUDE_PREFIXES;
    private static final ArrayList<String> INCLUDE_PREFIXES;
    static {
        EXCLUDE_PREFIXES = new ArrayList<> ();
        for (String s : Trace.EXCLUDE_PATTERNS)
            EXCLUDE_PREFIXES.add (s.substring (0, s.indexOf ('*')));
        INCLUDE_PREFIXES = new ArrayList<> ();
        for (String s : Trace.INCLUDE_PATTERNS)
            INCLUDE_PREFIXES.add (s.substring (0, s.indexOf ('*')));
    }
    public static boolean matchesExcludePrefix (String typeName) {
        ...
        for (String ignoreString : Format.EXCLUDE_PREFIXES)
            if (typeName.startsWith (ignoreString)) return true;
        return false;
    }
    public static boolean matchesExcludePrefixShow (String typeName) {
        for (String ignoreString : Format.INCLUDE_PREFIXES)
            if (typeName.startsWith (ignoreString)) return false;
            ...
            if (locals != null) {
                ...
                for (LocalVariable l : locals) 
                    if (l.isArgument ()) {
                        ...
                        sb.append (Graphviz.quote (Format.valueToStringShort (currFrame.getValue (l))));
                    }
            }
            sb.append (")\"");
...
/* private static */class Graphviz {
    ...
    static {
        setOutputFilenamePrefix(System.getProperty ("user.home") + "/Desktop/trace-");
    }
    ...
    private static void processPrimitiveArray (ArrayReference obj, PrintWriter out) {
        ...
        for (int i = 0, len = obj.length (); i < len; i++) {
            ...
            if (v != null) processValueInline ("", v, out);
        }
    ...
    private static boolean processValueInline (String prefix, Value val, PrintWriter out) {
        if (!canTreatAsPrimitive (val)) return false;
        if (val == null && !Trace.GRAPHVIZ_SHOW_NULL_FIELDS)
            return false;
        out.print (prefix);
        if (val == null) {
    ...
    private static void processPrimitiveAsObject (String gvName, Value val, PrintWriter out, Set<ObjectReference> visited) {
        String cabs = null;
        out.print (gvName + "[label=\"");
        boolean success = processValueInline ("", val, out);
        out.println ("\"" + Trace.GRAPHVIZ_WRAPPER_BOX_ATTRIBUTES + (cabs == null ? "" : "," + cabs) + "];");
        if (!success) {
            processValueStandalone (gvName, "", "", val, out, visited);
        }
    }
    ...
    private static void labelObjectWithSomePrimitiveFields (ObjectReference obj, List<Field> fs, PrintWriter out) {
        ...
        for (Field field : fs) {
            if (!canIgnoreObjectField (field)) {
                ...
                if (processValueInline (sep + name, obj.getValue (field), out)) sep = "|";
            }
        }
        String cabs = objectAttributeMap.get (obj.type ().name ());
    ...
    private static void processObject (ObjectReference obj, PrintWriter out, Set<ObjectReference> visited) {
        if (visited.add (obj)) {
            ...
            if (Trace.SHOW_BOXED_PRIMITIVES_AS_PRIMITIVE && Trace.GRAPHVIZ_SHOW_BOXED_PRIMITIVES_SIMPLY && Format.isWrapper (type)) {
                processPrimitiveAsObject (objectGvName (obj), obj, out, visited);
    ...
    private static void labelStaticClassWithSomePrimitiveFields (ReferenceType type, List<Field> fs, PrintWriter out) {
        ...
        for (Field field : fs) {
            if (!canIgnoreStaticField (field)) {
                String name = Trace.GRAPHVIZ_SHOW_FIELD_NAMES_IN_LABELS ? field.name () + " = " : "";
                if (processValueInline (sep + name, type.getValue (field), out)) sep = "|";
            }
        }
        String cabs = staticClassAttributeMap.get (type.name ());
    ...
    private static String frameName (int frameNumber, ReferenceType type, Method method, int lineNumber) {
        String objString = (Trace.GRAPHVIZ_SHOW_OBJECT_IDS) ? "@" + frameNumber + " : " : "";
    ...
    private static void labelFrameWithNoPrimitiveLocals (int frameNumber, StackFrame frame, PrintWriter out) {
        ...
        out.println (frameGvName (frameNumber) + "[label=\"" + frameName (frameNumber, type, method, location.lineNumber ()) + "\"" + Trace.GRAPHVIZ_FRAME_BOX_ATTRIBUTES
    ...
    private static void labelFrameWithSomePrimitiveLocals (int frameNumber, StackFrame frame, Map<LocalVariable, Value> ls, PrintWriter out) {
        ...
        ReferenceType type = location.declaringType ();
        Method method = location.method ();
        out.print (frameGvName (frameNumber) + "[label=\"" + frameName (frameNumber, type, method, location.lineNumber ()) + "|{");
        String sep = "";
        for (LocalVariable lv : ls.keySet ()) {
            String name = Trace.GRAPHVIZ_SHOW_FIELD_NAMES_IN_LABELS ? lv.name () + " = " : "";
            if (processValueInline (sep + name, ls.get (lv), out)) sep = "|";
        }
            ...
            // show the return value -- without this, it mysteriously disappears when drawing all steps
                if (returnVal != null && !(returnVal instanceof VoidValue)) {
                    if (canTreatAsPrimitive (returnVal)) {
                        out.print (PREFIX_RETURN + " [label=\"returnValue = ");
                        ...
                        out.println (PREFIX_RETURN + " [label=\"returnValue\"" + Trace.GRAPHVIZ_FRAME_RETURN_ATTRIBUTES + "];");
